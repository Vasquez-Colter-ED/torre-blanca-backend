    ...
    public void enviarCodigoRecuperacion(String destinatario, String nombre, String codigo) {
        try {
            Map<String, Object> body = Map.of(
                "from",    "Torre Blanca <onboarding@resend.dev>",
                "to",      new String[]{ destinatario },
                "subject", "Código de recuperación — Torre Blanca",
                "html",    buildEmailHtml(nombre, codigo)
            );
            ...
            <tr><td align="center">
              <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(15,23,42,0.08);">
                ...
                <tr><td style="padding:40px;">
                  ...
                  <p style="font-size:13px;color:#94A3B8;margin:0;line-height:1.6;">Si no solicitaste este código, ignora este correo.</p>
                </td></tr>
