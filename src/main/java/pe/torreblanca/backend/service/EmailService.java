...
public class EmailService {
    ...
    public void enviarCodigoRecuperacion(String destinatario, String nombre, String codigo) {
        try {
            System.out.println("[EMAIL] Preparando correo para: " + destinatario);

            MimeMessage mensaje = mailSender.createMimeMessage();
            MimeMessageHelper helper = new MimeMessageHelper(mensaje, true, "UTF-8");

            helper.setFrom("Torre Blanca <" + remitente + ">");
            ...
            System.err.println("[EMAIL] Error enviando correo a " + destinatario + ": " + e.getMessage());
              ...
              <table width="520" cellpadding="0" cellspacing="0"
                ...
                <tr><td style="padding:40px;">
                  ...
                  <p style="font-size:14px;color:#64748B;margin:0 0 32px 0;line-height:1.6;">
                    Usa el siguiente código para restablecer tu contraseña en Torre Blanca:
                  </p>
                ...
                <tr><td style="background:#F8FAFC;padding:20px 40px;border-top:1px solid #E2E8F0;">
                  <p style="margin:0;font-size:12px;color:#94A3B8;text-align:center;">
                    Residencial Torre Blanca · Chiclayo, Perú
                  </p>
                </td></tr>
