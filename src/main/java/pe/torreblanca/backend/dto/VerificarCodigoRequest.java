        ...
        for (char c : codigo.toCharArray()) {
            digitosHtml.append(String.format("""
                <td style="padding:0 6px;">
                  <div style="width:48px;height:56px;background:#F8FAFC;border:2px solid #E2E8F0;border-radius:10px;font-size:28px;font-weight:800;color:#0F172A;text-align:center;line-height:56px;">%s</div>
                </td>
            """, c));
        }
              ...
              <table width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 24px rgba(15,23,42,0.08);">
                ...
                <tr>
                  <td style="padding:40px;">
                    ...
                    <p style="font-size:14px;color:#64748B;margin:0 0 32px 0;line-height:1.6;">Recibimos una solicitud para restablecer la contraseña de tu cuenta. Usa el siguiente código para continuar:</p>
                    ...
                    <p style="font-size:13px;color:#94A3B8;margin:0;line-height:1.6;">Si no solicitaste este código, ignora este correo. Tu cuenta permanece segura.</p>
                  </td>
                </tr>
                <tr>
